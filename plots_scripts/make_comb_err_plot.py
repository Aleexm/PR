...
if __name__ == "__main__":
  make_comb_err_plot(os.path.join("results", "scenario1_results_comb.csv"), 
    os.path.join("output", "scenario1_hog_comb.jpg"), 
    "Test results using multiple stacked HOG features combining methods of non-linear classifiers for Scenario 1")
  make_comb_err_plot(os.path.join("results", "scenario1_results_comb_ldc.csv"), 
    os.path.join("output", "scenario1_hog_comb_ldc.jpg"), 
